...
#     """
#     Update surplus worksheet, add a new row with the surplus list data provided
#     """
...
def update_worksheet(data, worksheet):
    """
    Update sales and surplus worksheets, add a new row with the sales/surplus list data provided
    """
